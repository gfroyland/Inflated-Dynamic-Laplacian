...
2. A coherent-mixing-coherent (2-3-2) Double Gyre, another flow system with two counter-rotating gyres, this time of equal size, which undergoes two regime changes: one from a steady, coherent regime to a regime where fluid is mixing between the two rectangular gyre chambers, and then another back to the coherent regime again. Each flow regime lasts for an equal amount of time.
