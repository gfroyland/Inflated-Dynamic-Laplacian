...
Jason Atnip, Gary Froyland, and Péter Koltai. "An inflated dynamic Laplacian to track the emergence and disappearance of semi-material coherent sets", <i>Journal of Nonlinear Science</i>, vol. 36 (2026).
https://doi.org/10.1007/s00332-026-10301-8

The code provided here is for three systems, with definitions and descriptions of the first two of these systems provided in Sections 6.1 and 6.3 (respectively) of the above paper. Details on the third system can be found in Section 7.3 of [1]. The three systems in question are:
